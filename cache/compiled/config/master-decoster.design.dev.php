...
return [
    ...
    'checksum' => 'cc29de1c6b6c25f00d7a463c9301b33d',
    'files' => [
        'user/config' => [
            'security' => [
    ...
    'data' => [
        'plugins' => [
            'recaptchacontact' => [
                ...
                'grecaptcha_sitekey' => 'your reCAPTCHA site key',
                'grecaptcha_secret' => 'your secret-g-recaptcha-key',
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'Portfolio site of Darryll DeCoster. Interface, web and mobile design and development.'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
